...
import SiteAliasManager from "./components/SiteAliasManager";
...
function App() {
  ...
  const [randomFormat, setRandomFormat] = useState<
  ...
  const generateRandomString = (
    format: "private-mail" | "alphanumeric" | "words" | "timestamp",
    index: number = 0,
  ): string => {
                    ...
                    <div className="mb-3">
                      ...
                      <select
                        ...
                        onChange={async (e) => {
                          ...
                          // Save to settings
                          const result =
                            await browser.storage.local.get("app_settings");
                ...
                {activeGeneratorTab === "tags" && (
                  <div>
                    ...
                    <div className="mt-3 text-xs text-gray-500">
                      ...
                      <strong>your-tag</strong>@{baseEmail.split("@")[1]}
                    </div>
                  </div>
                )}
                  ...
                  >
                    <div className="flex items-center justify-center gap-1.5">
                      <svg
                        className="w-3.5 h-3.5"
                        fill={
                          viewMode === "favorites" ? "currentColor" : "none"
                        }
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    if (
                      ...
                      return (
                        <div className="text-center py-8 text-gray-500">
                          ...
                          <p className="text-xs">
                            Star emails from your history to quick access them
                            here
                          </p>
                        </div>
                      );
