    ...
    <div className="p-3.5">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-3">
          ...
          <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{stats.totalGenerated}</div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Total Generated</div>
        </div>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-3">
          ...
          <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{stats.createdToday}</div>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-3">
          ...
          <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{stats.createdThisWeek}</div>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-3">
          ...
          <div className="text-sm font-bold text-gray-900 dark:text-gray-100 truncate">{stats.mostUsedTag}</div>
