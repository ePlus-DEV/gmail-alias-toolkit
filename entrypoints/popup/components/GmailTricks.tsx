    ...
    <div>
      ...
      <div className="mb-3 space-y-2">
        <div className="flex items-center gap-3">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Number of variations</label>
          <input
            type="number"
            min="1"
            value={tricksCount}
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          <div className="bg-gray-50 dark:bg-gray-900 px-3 py-2 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Generated Variations</span>
              <span className="text-xs text-gray-500 dark:text-gray-400">{generatedTricks.length} total</span>
            </div>
          </div>
