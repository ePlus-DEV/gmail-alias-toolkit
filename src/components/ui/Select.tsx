// Source: beUI Motion Select: https://beui.dev/components/motion/select
"use client";
...
export function SelectTrigger({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative z-10 flex w-full items-center justify-between gap-2 rounded-lg border border-border bg-input px-3 py-2.5 text-sm text-foreground outline-none transition-colors",
        "hover:border-border focus-visible:ring-2 focus-visible:ring-ring/20",
...
export function SelectContent({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute left-0 right-0 z-20 rounded-lg border border-border bg-card shadow-lg backdrop-blur-xl",
