...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <div className="space-y-1.5">
      ...
      <motion.div
        animate={error && !reduce ? { x: [0, -3, 3, -2, 2, 0] } : undefined}
      ...
      >
        ...
        <input
          ...
          className={cn(
            "w-full rounded-xl border border-gray-200/90 bg-white/85 px-3 py-2.5 text-sm text-gray-900 shadow-sm outline-none transition-all placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700/80 dark:bg-gray-800/85 dark:text-gray-100",
            leftIcon && "pl-10",
            (rightIcon || error || success) && "pr-10",
            focused && "border-blue-400 ring-2 ring-blue-500/20",
        ...
        {focused && !reduce && (
          <motion.span
            layoutId="beui-input-caret"
            className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-blue-400/40"
