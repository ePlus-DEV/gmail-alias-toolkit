...
export function findBestEmailInput(): HTMLInputElement | null {
  ...
  if (
    ...
    active.matches(EMAIL_INPUT_SELECTOR)
  )
    return active;
  return document.querySelector<HTMLInputElement>(EMAIL_INPUT_SELECTOR);
}
export function autofillEmail(alias: string): boolean {
