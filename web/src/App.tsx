...
const features = [
  [
    ...
    "Create secure aliases with private-mail, alphanumeric, random words and timestamp formats.",
    Sparkles,
  ],
  [
    "Custom Tags & Presets",
    "Save common tags for shopping, work, newsletters, testing and project-specific aliases.",
    Tags,
  ],
  [
    "Searchable History",
    "Find generated aliases quickly with history, tags and account-based organization.",
    Search,
  ],
  [
    "Favorites",
    "Pin aliases you reuse often so they are always one click away.",
    Star,
  ],
  [
    "QR Code Sharing",
  ...
  [
    "Local-first Privacy",
    "Alias data stays in browser storage with no tracking or analytics.",
    ShieldCheck,
  ],
] as const;
...
const steps = [
  [
    "01",
    "Choose a format",
    "Pick random words, alphanumeric, timestamp or private-mail style.",
  ],
  [
    "02",
    "Generate alias",
    "Create name+tag@gmail.com instantly and copy it to your clipboard.",
  ],
  [
    "03",
    "Organize later",
    "Search history, favorite important aliases, export data when needed.",
  ],
] as const;
    ...
    <main className="min-h-screen overflow-hidden bg-slate-50 text-slate-950">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.05fr_.95fr] lg:py-28">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              ...
              <strong className="text-slate-950">name+tag@gmail.com</strong>{" "}
              aliases, save presets, manage history, favorite important aliases
              and export your data — directly in your browser.
            </p>
            ...
            <div className="mt-10 grid max-w-xl grid-cols-3 gap-4">
              {["Local storage", "No tracking", "CSV/JSON export"].map(
                (item) => (
                  <div
                    key={item}
      ...
      <section id="features" className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
            Everything needed to control Gmail aliases
          </h2>
          <p className="mt-4 text-slate-600">
            A focused browser extension for faster alias creation, cleaner
            history and local-first privacy.
          </p>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[.75fr_1.25fr]">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Use aliases to track signups, test forms, separate newsletters,
                protect your main email and identify who leaked your address.
              </p>
            </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-300">
                The extension is built around local browser storage. Generate
                aliases quickly without a remote API, analytics or tracking.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                [EyeOff, "No analytics"],
                [ShieldCheck, "No tracking"],
                [Database, "Local storage"],
                [Moon, "Light/Dark mode"],
              ].map(([Icon, text]) => {
                ...
                return (
                  ...
                  >
                    <PrivacyIcon className="mb-4 h-6 w-6 text-blue-300" />
      ...
      <section className="mx-auto max-w-5xl px-5 pb-24 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-600">
          Install Gmail Alias Toolkit to generate aliases faster, organize
          history and keep your email workflow under control.
        </p>
